...
<%@ page import="com.example.rent.service.HouseService" %>
<%@ page import="com.example.rent.service.impl.HouseServiceImpl" %>
<%@ page import="java.util.List" %>
<%@ page import="com.example.rent.entity.House" %><%--
...
<%
    ...
    List<House> houses = houseService.getHouseByUserId(user.getUserId());
%>
<!-- 个人界面顶部栏定义区域 -->
<div class="header-mod">
    <div class="header clearfix">
        ...
        <!--定义发布租房按钮-->
        <button class="releaseBtn" onclick="openHouseReleasing()">发布租房</button>
        <!-- 定义退出按钮 -->
...
<div class="headerSub-mod">
    <div class="headerSub clearfix">
        <!-- 插入用户头像 -->
        <img src="<%=user.getIcon()%>" class="user-photo" alt="用户头像">
        ...
        <div class="user-info">
            ...
            <div class="info-sub clearfix">
                <ul>
                    <li class="user-account">账户名：<span><%=user.getUserName()%></span> </li>
    ...
    <div class="content clearfix">
        ...
        <div class="side-menu">
            <ul class="menu-list">
                ...
                <li>
                    <a href="javascript:void(0);" class=""><img src="../img/icon/add.png">&nbsp;&nbsp;&nbsp;&nbsp;我的发布</a>
                </li>
                <li>
                    ...
                    <div class="profile item">
                        ...
                        <ul class="profile-list">
                            ...
                            <li class="phone">
                                ...
                                <span class="value"><%=user.getTelephone()%></span>
                    ...
                    <div class="item">
                        <div class="detailinfo">
                            <ul>
                                ...
                                %>
                                <li>
                                    <img src="<%=house.getHouseImg()%>" style="width: 180px; border-radius: 10%;">
...
<script>
    function openHouseReleasing() {
        window.location.href ="../house_releasing.jsp";
    }
    ...
    $('#delete .yes').click(function() {
        // 要传一个houseId
        var houseId = $('.house-delete').attr('name');
        $.get("/rentingSystem/houseDeleteServlet", {houseId: houseId});
        //location.reload();
        $('#delete').hide();
    })
